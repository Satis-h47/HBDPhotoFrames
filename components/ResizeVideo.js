...
export default function ResizeVideo() {
  ...
  const baseSize = 100;
const baseFontSize = 18; // your initial font size

const dynamicFontSize = Math.min(
  (size.width / baseSize) * baseFontSize,
  (size.height / baseSize) * baseFontSize
);
...
<GestureDetector gesture={pan}>
  ...
  >
    ...
    <Text style={[styles.text, { fontSize: dynamicFontSize }]}>
      Happy Birthday Chinnari babu kalyan
    </Text>
</View>
