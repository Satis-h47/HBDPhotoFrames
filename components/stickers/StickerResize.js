...
export default function StickerResize({sticker, onDelete, onTapped}) {
  ...
  return (
    ...
    <GestureDetector gesture={Handler}>
      <Animated.View ref={boxRef} style={[
        boxStyle, {
          position: 'absolute',
          borderWidth: sticker.tapped ? 1 : 1,
          borderColor: sticker.tapped ? 'white' : 'transparent',
        ...
        {
          sticker.tapped ?
            <TouchableWithoutFeedback onPress={() => onTapped(sticker)}>
              <View
          ...
          {/* <Image source={{ uri: 'https://storage.googleapis.com/happybirthdaystickers/balloons/Balloon_1.png' }}
                                    style={{
                                        height: 70, width: 70,
                                        backgroundColor: '#ddd',
                                    }} /> */}
                ...
                <Pressable onPress={() => onDelete(sticker)}
                  style={[styles.iconBox, {
                    top: 0,
                    zIndex: 3,
                    left: 0,
                ...
                >
                  {/* <Text onPress={() => onEdit(text)}>✏️</Text> */}
                                        <Image
                        source={require('../../assets/icons/sticker_flip_2.png')}
                        style={{height:30,width:30}}
                        resizeMode="cover" />
